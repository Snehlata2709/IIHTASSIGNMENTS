...
//		target.setSanctionOutputDto(sanctionOutputDto);
		...
		public static SanctionInfo parse(Long managerId, Long loanAppId, SanctionOutputDto source) {
			...
			LocalDate loanclosedate= date.plusYears(new Double(source.getTermOfLoan()).longValue());
			...
			System.out.println("TermPaymentAmount:"+ termPaymentAmount);
			Double monthlyPayment = termPaymentAmount/(source.getTermOfLoan()*12);
			System.out.println("TermPaymentAmount:"+ monthlyPayment);
