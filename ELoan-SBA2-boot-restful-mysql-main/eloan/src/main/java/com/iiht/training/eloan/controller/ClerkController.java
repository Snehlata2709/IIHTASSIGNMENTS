...
public class ClerkController {
	...
	public ResponseEntity<List<LoanOutputDto>> allAppliedLoans() throws ExceptionResponse {
		//return null;
	...
	public ResponseEntity<ProcessingDto> processLoan(@PathVariable Long clerkId,
													 ...
													 @Valid @RequestBody ProcessingDto processingDto) throws ExceptionResponse{
